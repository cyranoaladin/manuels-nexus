...
| 4 | Matrice capacités × parcours (≥2 ex/case, ratio 40/40/20, ≥50 ex/chapitre) + corrigés copie-modèle + CDP | `make verify` 0 fail, ruff clean, similarité (hors T0), couverture 0 manquant |
...
| 7 | Assemblage, check-list docs/01 Partie 8 + check-list NSI (CDC §6), tag | Tout ❌ corrigé avant chapitre suivant |
