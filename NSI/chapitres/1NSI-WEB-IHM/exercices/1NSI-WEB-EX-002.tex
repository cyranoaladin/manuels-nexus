% META: {"id": "1NSI-WEB-EX-002", "chapitre": "1NSI-WEB-IHM", "type_objet": "exercice", "capacites": ["P-IHM-02"], "parcours": 1, "competences": ["calculer"], "duree_min": 12, "mode_creation": "ex_nihilo", "sources_inspiration": [], "fichier_tex": "chapitres/1NSI-WEB-IHM/exercices/1NSI-WEB-EX-002.tex", "corrige_tex": "chapitres/1NSI-WEB-IHM/corriges/1NSI-WEB-CO-002.tex", "status": "generated"}
% BEGIN-VERIFY
% gestionnaires = {}
...
On reprend le modèle de gestionnaire d'événements du cours (\lstinline{ajouter_gestionnaire},
\lstinline{declencher_clic}). Un menu de navigation doit s'afficher ou se masquer à chaque
clic sur un bouton \lstinline{"bouton_menu"} (un menu \og bascule \fg{}, comme sur un site
mobile).
\begin{enumerate}
