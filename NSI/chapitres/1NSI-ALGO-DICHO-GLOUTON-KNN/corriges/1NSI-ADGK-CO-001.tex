% META: {"id": "1NSI-ADGK-CO-001", "chapitre": "1NSI-ALGO-DICHO-GLOUTON-KNN", "type_objet": "corrige", "exercice_ref": "1NSI-ADGK-EX-001", "capacites": ["P-ALGO-04"], "sources_inspiration": [], "status": "verified"}
% BEGIN-VERIFY
...
\begin{center}
\begin{tabular}{cccc}
  \texttt{borne\_inf} & \texttt{borne\_sup} & \texttt{milieu} & \texttt{tableau\_trie[milieu]} \\\hline
  0 & 9 & 4 & 16 \\
  5 & 9 & 7 & 45 \\
  5 & 6 & 5 & 23 \\
\end{tabular}
