% META: {"id": "1NSI-ADGK-ME-001", "chapitre": "1NSI-ALGO-DICHO-GLOUTON-KNN", "type_objet": "methode", "capacites": ["P-ALGO-04"], "capacites_codes": ["C1"], "methodes": ["M1"], "mode_creation": "ex_nihilo", "sources_inspiration": [], "status": "needs_review"}
...
\begin{itemize}
  ...
  \item Oublier le cas du tableau vide : avec \lstinline{g = 0} et \lstinline{d = -1}, la boucle ne s'exécute pas et on renvoie bien \lstinline{None}.
\end{itemize}
