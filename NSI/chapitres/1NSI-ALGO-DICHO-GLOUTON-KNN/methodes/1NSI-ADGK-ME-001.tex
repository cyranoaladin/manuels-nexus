...
\begin{enumerate}
  ...
  \item Si la boucle se termine sans trouver, renvoie \lstinline{None}.
...
recherche_dichotomique(t, 4)    # renvoie None
\end{python}
Sur \lstinline{t} (8 valeurs), chercher 13 fait décroître le variant $d-g$ :
$7 \to 3 \to 1$ — trois tours suffisent, contre jusqu'à 8 pour un parcours séquentiel.
