% META: {"id": "TNSI-STRUCT-CO-001", "chapitre": "TNSI-STRUCTURES-DONNEES", "type_objet": "corrige", "exercice_ref": "TNSI-STRUCT-EX-001", "capacites_codes": ["C03A", "C03B"], "sources_inspiration": [], "status": "generated"}
% BEGIN-VERIFY
% class Pile:
%     def __init__(self):
%         self._d = []
