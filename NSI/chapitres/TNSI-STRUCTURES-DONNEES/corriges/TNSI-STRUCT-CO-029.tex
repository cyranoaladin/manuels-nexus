% META: {"id": "TNSI-STRUCT-CO-029", "chapitre": "TNSI-STRUCTURES-DONNEES", "type_objet": "correction", "exercice_ref": "TNSI-STRUCT-EX-001", "capacites_codes": ["C8"], "sources_inspiration": [], "status": "approved", "capacites": ["TNSI-STRUCTURES-DONNEES-C8"], "parcours": 1, "fichier_exercice": "chapitres/TNSI-STRUCTURES-DONNEES/exercices/TNSI-STRUCT-EX-029.tex"}
% BEGIN-VERIFY
% class Pile:
%     def __init__(self):
%         self._d = []
