% META: {"id": "TNSI-STRUCT-CO-025", "chapitre": "TNSI-STRUCTURES-DONNEES", "type_objet": "correction", "exercice_ref": "TNSI-STRUCT-EX-001", "capacites_codes": ["C7"], "sources_inspiration": [], "status": "approved", "capacites": ["TNSI-STRUCTURES-DONNEES-C7"], "parcours": 1, "fichier_exercice": "chapitres/TNSI-STRUCTURES-DONNEES/exercices/TNSI-STRUCT-EX-025.tex"}
% BEGIN-VERIFY
% class Pile:
%     def __init__(self):
%         self._d = []
