% META: {"id": "TNSI-STRUCT-CO-037", "chapitre": "TNSI-STRUCTURES-DONNEES", "type_objet": "correction", "exercice_ref": "TNSI-STRUCT-EX-001", "capacites_codes": ["C10"], "sources_inspiration": [], "status": "approved", "capacites": ["TNSI-STRUCTURES-DONNEES-C10"], "parcours": 2, "fichier_exercice": "chapitres/TNSI-STRUCTURES-DONNEES/exercices/TNSI-STRUCT-EX-037.tex"}
% BEGIN-VERIFY
% class Pile:
%     def __init__(self):
%         self._d = []
