% META: {"id": "TNSI-STRUCT-CO-021", "chapitre": "TNSI-STRUCTURES-DONNEES", "type_objet": "correction", "exercice_ref": "TNSI-STRUCT-EX-001", "capacites_codes": ["C6"], "sources_inspiration": [], "status": "approved", "capacites": ["TNSI-STRUCTURES-DONNEES-C6"], "parcours": 1, "fichier_exercice": "chapitres/TNSI-STRUCTURES-DONNEES/exercices/TNSI-STRUCT-EX-021.tex"}
% BEGIN-VERIFY
% class Pile:
%     def __init__(self):
%         self._d = []
