\section{P04 - Remédiation - Types construits}
...
\item
  Diagnostic : refaire tuple de coordonnées avec \texttt{(36.8,\ 10.2)}
  et repérer l'étape fautive.
\item
  Activité corrective EF1 : Identifier mutabilité et usage avant
  d'écrire une affectation.
\item
  Nouvelle tâche : produire une réponse sur un cas voisin qui vérifie «
  tentative de modification interdite ».
\item
  Critère de sortie : l'élève explique la correction sans reprendre la
  phrase du cours. \#\#\# Remédiation EF2
\item
  Erreur fréquente EF2 - Parcourir les indices quand les valeurs
  suffisent.
\item
  Diagnostic : refaire liste de relevés avec \texttt{{[}18,\ 20,\ 19{]}}
  et repérer l'étape fautive.
\item
...
\item
  Critère de sortie : l'élève explique la correction sans reprendre la
  phrase du cours. \#\#\# Remédiation EF3
\item
  Erreur fréquente EF3 - Accéder à une clé sans vérifier sa présence.
\item
  Diagnostic : refaire dictionnaire avec
  \texttt{\{"température":\ 21,\ "vent":\ 12\}} et repérer l'étape
  fautive.
\item
...
\item
  Critère de sortie : l'élève explique la correction sans reprendre la
  phrase du cours. \#\#\# Remédiation EF4
\item
  Erreur fréquente EF4 - Copier une liste imbriquée seulement au premier
  niveau.
\item
  Diagnostic : refaire copie de liste avec
  \texttt{{[}{[}1{]},\ {[}2{]}{]}} et repérer l'étape fautive.
\item
...
\item
  Critère de sortie : l'élève explique la correction sans reprendre la
  phrase du cours. \#\# Exercices numérotés
\item
