...
\begin{itemize}
  ...
  \item \textbf{Recopier le code de la bibliothèque dans son programme.} On alourdit le
    fichier et surtout on se coupe des corrections ultérieures : la version recopiée gardera
    ses bugs pour toujours. Un \lstinline{import} suffit.
\end{itemize}
