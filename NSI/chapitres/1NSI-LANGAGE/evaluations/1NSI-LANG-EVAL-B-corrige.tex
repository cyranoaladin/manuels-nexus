...
de nombres ; la fonction renvoie un entier, l'indice du plus grand element.
...
\begin{itemize}
  ...
  deja ce maximum -- ce qui exprime la regle « le plus petit indice en cas d'egalite ».
\end{itemize}
...
\lstinline{>=}, une egalite ferait avancer l'indice retenu.

\textbf{3.} \textbf{Trait commun :} les deux langages ont des fonctions nommees, des
variables, une boucle qui parcourt les indices, et la meme logique de comparaison --
