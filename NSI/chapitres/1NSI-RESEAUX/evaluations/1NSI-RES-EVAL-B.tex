% META: {"id": "1NSI-RES-EVAL-B", "chapitre": "1NSI-RESEAUX", "type_objet": "evaluation", "capacites": ["P-ARCH-02A", "P-ARCH-02B", "P-ARCH-02C", "P-ARCH-04A"], "mode_creation": "ex_nihilo", "sources_inspiration": [], "duree_min": 45, "status": "generated"}
...
\begin{enumerate}
  \item (4 pts) Découper le message \lstinline{"PAQUETSRESEAU"} en paquets de taille maximale $5$ avec \lstinline{decouper_en_paquets} du cours. Combien de paquets sont créés, et que contiennent-ils ?
...
\begin{enumerate}
  \item (4 pts) On donne le réseau \lstinline|{"X": ["Y"], "Y": ["X", "Z"], "Z": ["Y"]}|. En utilisant \lstinline{peuvent_communiquer} du cours, vérifier que \lstinline{"X"} et \lstinline{"Z"} peuvent communiquer.
