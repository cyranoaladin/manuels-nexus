...
doit etre refusee par une erreur explicite.

\begin{enumerate}
  \item (3 pts) Ecrire les fonctions \lstinline{traiter_commande(commande)} et
  \lstinline{ventilation_active(co2)} realisant ce cahier des charges, sur le modele du
  thermostat du cours.
