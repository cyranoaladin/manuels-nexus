% META: {"id": "TNSI-BDD-COURS-03", "chapitre": "TNSI-BASES-DE-DONNEES", "type_objet": "cours", "capacites_codes": ["C3"], "sources_inspiration": [], "mode_creation": "ex_nihilo", "status": "approved", "capacites": ["TNSI-BASES-DE-DONNEES-C3"]}
...
\begin{sql}
CREATE TABLE Livre(id INTEGER PRIMARY KEY, titre TEXT, auteur TEXT, année INTEGER);
...
\begin{sql}
SELECT titre FROM Livre WHERE année > 1945;
\end{sql}
