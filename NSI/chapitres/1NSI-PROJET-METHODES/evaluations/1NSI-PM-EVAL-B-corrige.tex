...
\textbf{1.} La docstring nomme le role, les parametres avec leur type, la valeur renvoyee
...
zero, dont le message ne dit rien du probleme reel.
...
\begin{itemize}
  ...
  \item \textbf{Une demonstration courte.} Argument : une execution reelle sur un jeu de
