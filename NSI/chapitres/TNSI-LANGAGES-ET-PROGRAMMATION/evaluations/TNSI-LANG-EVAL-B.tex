...
\begin{enumerate}
  \item (2 pts) Écrire le code qui, pour la serie \lstinline{[4, 8, 6, 10]}, affiche la
  moyenne et la médiane en utilisant cette bibliotheque plutot qu'en les recalculant.
...
\begin{enumerate}
  ...
  différentes.
  \item (1 pt) Pour écrire l'interface graphique d'une application, puis pour transformer une
