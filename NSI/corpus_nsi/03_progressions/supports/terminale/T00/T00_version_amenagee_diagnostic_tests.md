---
title: "T00 - Version amenagee - Diagnostic tests"
level: "terminale"
sequence_id: "T00"
...
# T00 - Version aménagée - Diagnostic tests
...
### Question aménagée 1
- Énoncé élève : traiter maximum nominal avec la donnée `[3, 7, 2]`.
- Aide intégrée : commencer par parcourir la liste en conservant le meilleur élément.
...
### Question aménagée 2
- Énoncé élève : traiter liste vide avec la donnée `[]`.
- Aide intégrée : commencer par refuser l’entrée avant le parcours.
- Espace de réponse : méthode : ______ ; résultat : ______ ; contrôle : ______.
- Point de vigilance : Écrire un test qui reproduit le code au lieu de la spécification.
### Question aménagée 3
- Énoncé élève : traiter assertion avec la donnée `assert maximum([1]) == 1`.
- Aide intégrée : commencer par traduire une exigence en test exécutable.
- Espace de réponse : méthode : ______ ; résultat : ______ ; contrôle : ______.
- Point de vigilance : Oublier le cas vide.
### Question aménagée 4
- Énoncé élève : traiter entrée invalide avec la donnée `[1, "x"]`.
- Aide intégrée : commencer par définir si le mélange de types est autorisé.
- Espace de réponse : méthode : ______ ; résultat : ______ ; contrôle : ______.
- Point de vigilance : Ne pas lire le message d’échec.
## Exercices numérotés
- Exercice 1 : résoudre maximum nominal avec `[3, 7, 2]` avec aide possible sur la méthode.
- Exercice 2 : expliquer liste vide à partir de `[]` avec aide possible sur la méthode.
- Exercice 3 : comparer assertion avec `assert maximum([1]) == 1` avec aide possible sur la méthode.
- Exercice 4 : corriger entrée invalide pour `[1, "x"]` avec aide possible sur la méthode.
- Exercice 5 : tester un cas limite lié à liste d’un élément avec aide possible sur la méthode.
- Exercice 6 : classer deux méthodes possibles pour liste vide avec aide possible sur la méthode.
- Exercice 7 : justifier un transfert qui utilise assertion avec une donnée nouvelle avec aide possible sur la méthode.
- Exercice 8 : étendre un énoncé volontairement erroné sur entrée invalide avec aide possible sur la méthode.
