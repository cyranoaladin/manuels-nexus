---
title: "T05 - Version amenagee - Arbres binaires"
level: "terminale"
sequence_id: "T05"
...
# T05 - Version aménagée - Arbres binaires
...
### Question aménagée 1
- Énoncé élève : traiter arbre feuille avec la donnée `7`.
- Aide intégrée : commencer par reconnaître l’absence de fils.
- Espace de réponse : méthode : ______ ; résultat : ______ ; contrôle : ______.
- Point de vigilance : Confondre hauteur et nombre de nœuds.
### Question aménagée 2
- Énoncé élève : traiter hauteur avec la donnée racine avec deux feuilles.
- Aide intégrée : commencer par prendre 1 plus le maximum des hauteurs des sous-arbres.
- Espace de réponse : méthode : ______ ; résultat : ______ ; contrôle : ______.
- Point de vigilance : Oublier le cas arbre vide.
### Question aménagée 3
- Énoncé élève : traiter parcours préfixe avec la donnée `+ 2 3`.
- Aide intégrée : commencer par visiter racine puis gauche puis droite.
- Espace de réponse : méthode : ______ ; résultat : ______ ; contrôle : ______.
- Point de vigilance : Mélanger parcours préfixe et infixe.
### Question aménagée 4
- Énoncé élève : traiter évaluation avec la donnée `(2 + 3) * 4`.
- Aide intégrée : commencer par évaluer les sous-arbres avant l’opérateur parent.
- Espace de réponse : méthode : ______ ; résultat : ______ ; contrôle : ______.
- Point de vigilance : Évaluer un opérateur avant ses opérandes.
## Exercices numérotés
- Exercice 1 : résoudre arbre feuille avec `7` avec aide possible sur la méthode.
- Exercice 2 : expliquer hauteur à partir de racine avec deux feuilles avec aide possible sur la méthode.
- Exercice 3 : comparer parcours préfixe avec `+ 2 3` avec aide possible sur la méthode.
- Exercice 4 : corriger évaluation pour `(2 + 3) * 4` avec aide possible sur la méthode.
- Exercice 5 : tester un cas limite lié à arbre vide avec aide possible sur la méthode.
- Exercice 6 : classer deux méthodes possibles pour hauteur avec aide possible sur la méthode.
- Exercice 7 : justifier un transfert qui utilise parcours préfixe avec une donnée nouvelle avec aide possible sur la méthode.
- Exercice 8 : étendre un énoncé volontairement erroné sur évaluation avec aide possible sur la méthode.
