---
title: "T05 - Trace - Arbres binaires"
level: "terminale"
sequence_id: "T05"
document_type: "trace"
status: "needs_review"
...
# T05 - Trace écrite - Arbres binaires
...
### Repère 1 - arbre feuille
- À retenir : reconnaître l’absence de fils.
- Exemple minimal : `7` donne hauteur 0.
- Vigilance : contrôler « arbre vide ».
- Question flash : que devient la méthode si la donnée change légèrement ?
### Repère 2 - hauteur
- À retenir : prendre 1 plus le maximum des hauteurs des sous-arbres.
- Exemple minimal : racine avec deux feuilles donne hauteur 1.
- Vigilance : contrôler « un seul fils ».
- Question flash : que devient la méthode si la donnée change légèrement ?
### Repère 3 - parcours préfixe
- À retenir : visiter racine puis gauche puis droite.
- Exemple minimal : `+ 2 3` donne `+, 2, 3`.
- Vigilance : contrôler « nœud feuille ».
- Question flash : que devient la méthode si la donnée change légèrement ?
### Repère 4 - évaluation
- À retenir : évaluer les sous-arbres avant l’opérateur parent.
- Exemple minimal : `(2 + 3) * 4` donne `20`.
- Vigilance : contrôler « division par zéro si opérateur `/` ».
- Question flash : que devient la méthode si la donnée change légèrement ?
## Exercices numérotés
