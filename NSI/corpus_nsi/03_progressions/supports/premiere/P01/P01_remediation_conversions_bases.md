...
# P01 - Remédiation - Conversions entre bases
...
- Diagnostic : refaire décimal vers binaire avec `13` en base dix et repérer l’étape fautive.
- Activité corrective EF1 : Rejouer la division de 45 en deux colonnes : quotient et reste.
- Nouvelle tâche : produire une réponse sur un cas voisin qui vérifie « 0 se code 0 ».
...
- Diagnostic : refaire binaire vers décimal avec `101101₂` et repérer l’étape fautive.
- Activité corrective EF2 : Annoter chaque bit par son poids avant toute addition.
- Nouvelle tâche : produire une réponse sur un cas voisin qui vérifie « un seul bit à 1 ».
- Critère de sortie : l’élève explique la correction sans reprendre la phrase du cours.
### Remédiation EF3
- Erreur fréquente EF3 - Former des paquets hexadécimaux sans compléter à gauche.
- Diagnostic : refaire binaire vers hexadécimal avec `11110000₂` et repérer l’étape fautive.
- Activité corrective EF3 : Compléter `101101₂` en `0010 1101₂` puis lire les deux paquets.
- Nouvelle tâche : produire une réponse sur un cas voisin qui vérifie « complément à gauche si le nombre de bits n’est pas multiple de 4 ».
- Critère de sortie : l’élève explique la correction sans reprendre la phrase du cours.
### Remédiation EF4
- Erreur fréquente EF4 - Accepter un chiffre interdit dans la base utilisée.
- Diagnostic : refaire décimal vers hexadécimal avec `255` et repérer l’étape fautive.
- Activité corrective EF4 : Entourer chaque symbole et vérifier qu’il appartient à l’alphabet de la base.
- Nouvelle tâche : produire une réponse sur un cas voisin qui vérifie « chiffre hexadécimal maximal F ».
- Critère de sortie : l’élève explique la correction sans reprendre la phrase du cours.
## Exercices numérotés
