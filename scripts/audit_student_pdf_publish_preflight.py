...
def build_payload() -> dict:
    ...
    return {
        ...
        "schema_version": 1,
        # Aucune date de generation litterale : recopiee d'une execution a
        # l'autre, elle finit par dater un contenu qu'elle n'a pas observe.
        # La provenance reelle est portee par le SHA de source ci-dessous.
        "generated_by": "scripts/audit_student_pdf_publish_preflight.py",
