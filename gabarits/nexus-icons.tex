...
\newcommand{\nxLosange}[1][nxOr]{%
  \tikz[baseline=-0.15em]{%
    ...
    \draw[nxBleu,line width=0.4pt] (0,0) -- (0.3em,0.45em) -- (0.6em,0) -- (0.3em,-0.45em) -- cycle;
  }%
}
...
% ============================================================
\renewcommand{\pictoOral}{\icnOral~\textcolor{nxBleu}{Oral}}
\renewcommand{\pictoPython}{\icnPython~\textcolor{nxBleu}{\texttt{Python}}}
