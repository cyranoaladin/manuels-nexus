...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item \textbf{B} — Le signe negatif de $f'$ renseigne sur les variations de $f$ ; il ne permet pas d'affirmer que $f(2{,}5)=0$. \emph{Renvoi : M3.}
    \item \textbf{D} — Le signe de $f'$ renseigne sur les variations de $f$, pas sur la convexite, qui s'etudie avec les variations de $f'$ ou le signe de $f''$. \emph{Renvoi : M3.}
  \end{itemize}
  \item \textbf{Q9}
  \begin{itemize}
    ...
    \item \textbf{D} — Une asymptote verticale concerne le comportement de $f$ au voisinage d'une valeur ; l'annulation de $f'$ avec changement de signe decrit ici un extremum. \emph{Renvoi : M3.}
  \end{itemize}
  \item \textbf{Q10}
  \begin{itemize}
