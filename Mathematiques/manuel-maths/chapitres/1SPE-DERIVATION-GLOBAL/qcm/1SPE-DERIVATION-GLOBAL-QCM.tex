% META: {"id": "1SPE-DERIVATION-GLOBAL-QCM", "chapitre": "1SPE-DERIVATION-GLOBAL", "type_objet": "qcm", "capacites": ["1SPE-DERIVATION-GLOBAL-C1", "1SPE-DERIVATION-GLOBAL-C2", "1SPE-DERIVATION-GLOBAL-C3", "1SPE-DERIVATION-GLOBAL-C4", "1SPE-DERIVATION-GLOBAL-C5"], "genere_depuis": "chapitres/1SPE-DERIVATION-GLOBAL/qcm/1SPE-DERIVATION-GLOBAL-QCM.json", "status": "generated"}
...
\begin{itemize}
  \item \textbf{Q1}
  \begin{itemize}
    \item \textbf{B} — Oubli du coefficient $n$ dans la formule $(x^n)' = n x^{n-1}$. \emph{Renvoi : M1.}
  ...
  \begin{itemize}
    ...
    \item \textbf{C} — Dénominateur 2 omis dans la formule de dérivation de $\sqrt{x}$. \emph{Renvoi : M1.}
  ...
  \begin{itemize}
    ...
    \item \textbf{D} — L'élève recopie la fonction $1/x$ sans la dériver ; sa dérivée vaut $-1/x^2$. \emph{Renvoi : M1.}
  \end{itemize}
  \item \textbf{Q4}
  \begin{itemize}
  ...
  \begin{itemize}
    ...
    \item \textbf{C} — Somme des dérivées. \emph{Renvoi : M2.}
  ...
  \begin{itemize}
    ...
    \item \textbf{B} — Quotient des dérivées. \emph{Renvoi : M2.}
  ...
  \begin{itemize}
    ...
    \item \textbf{C} — Signe de $f'$ confondu avec annulation de $f$. \emph{Renvoi : M3.}
  \end{itemize}
  \item \textbf{Q8}
  \begin{itemize}
    \item \textbf{B} — Racine de $f$ au lieu du signe de $f'$. \emph{Renvoi : M3.}
    \item \textbf{C} — Intervalle de croissance pris au lieu de décroissance. \emph{Renvoi : M3.}
    \item \textbf{D} — Le signe de $f'$ déterminé les variations de $f$, pas sa convexité. La convexité s'etudie a l'aide de $f''$. \emph{Renvoi : M3.}
  \end{itemize}
  \item \textbf{Q9}
  \begin{itemize}
    \item \textbf{A} — Changement $+ \to -$ correspond à un maximum, pas un minimum. \emph{Renvoi : M3, M4.}
    \item \textbf{C} — Annulation de $f'$ avec changement de signe donne un extremum. \emph{Renvoi : M4.}
  ...
  \begin{itemize}
    ...
    \item \textbf{B} — $x=6$ correspond à $B'(6) = -6 \neq 0$. \emph{Renvoi : M4.}
  ...
  \begin{itemize}
    ...
    \item \textbf{B} — $f'$ change de signe donc c'est bien un extremum. \emph{Renvoi : M4.}
    \item \textbf{C} — Pas de point d'inflexion pour une parabole. \emph{Renvoi : M4.}
  \end{itemize}
  \item \textbf{Q12}
  \begin{itemize}
    \item \textbf{B} — $f(x)=0$ donne les racines de $f$, pas ses extremums. \emph{Renvoi : M4.}
  ...
  \item \textbf{Q14}
  \begin{itemize}
    \item \textbf{A} — $V'(60)=0$, mais $60$ est hors de l'intervalle ouvert $]0;60[$ impose par l'énoncé ; ce n'est donc pas une valeur admissible de $x$. \emph{Renvoi : M5.}
    \item \textbf{B} — L'élève a remplace a tort le facteur $120 - 6x$ de $V'(x)=(120-2x)(120-6x)$ par $120 - 3x$ ; résoudre $120 - 3x=0$ conduit exactement a $x=40$. \emph{Renvoi : M5.}
    \item \textbf{D} — L'élève a remplace a tort le facteur $120 - 6x$ par $60 - 6x$ ; résoudre $60 - 6x=0$ conduit exactement a $x=10$. \emph{Renvoi : M5.}
  \end{itemize}
  \item \textbf{Q15}
  \begin{itemize}
    \item \textbf{A} — Les valeurs de $f'$ ne sont pas les valeurs de la fonction $f$. \emph{Renvoi : M5.}
    \item \textbf{B} — Le point critique intérieur doit aussi être vérifié. \emph{Renvoi : M5.}
