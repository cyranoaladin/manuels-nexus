% META: {"id": "1SPE-DERGLOBAL-EV-A", "chapitre": "1SPE-DERIVATION-GLOBAL", "type_objet": "evaluation", "capacites_codes": ["C1", "C2", "C3", "C4", "C5"], "duree_min": 55, "points": 20, "status": "generated", "sympy_params": {"f_ex1": "3*x**2 - 2*x + 1", "a_ex1": 2, "f_ex2": "x**3 - 6*x", "f_ex3": "(x**2+2)/(x-1)", "f_ex4": "x*(20-x)"}, "version": "A"}
