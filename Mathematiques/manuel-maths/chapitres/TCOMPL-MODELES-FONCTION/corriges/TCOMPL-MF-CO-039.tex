% META: {"id": "TCOMPL-MF-CO-039", "chapitre": "TCOMPL-MODELES-FONCTION", "type_objet": "corrige", "exercice_ref": "TCOMPL-MF-EX-039", "capacites_codes": ["C4"], "sources_inspiration": [], "status": "approved"}
% BEGIN-VERIFY
% from sympy import *
% x = symbols('x')
% f = ln(x)
...
% END-VERIFY
\begin{corrige}{TCOMPL-MF-EX-039}
