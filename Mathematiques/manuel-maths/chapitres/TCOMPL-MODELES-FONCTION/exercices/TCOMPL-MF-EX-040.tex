% META: {"id": "TCOMPL-MF-EX-040", "chapitre": "TCOMPL-MODELES-FONCTION", "type_objet": "exercice", "capacites": ["TCOMPL-MF-C5"], "capacites_codes": ["C5"], "methodes": ["M4"], "parcours": 2, "competences": ["raisonner"], "duree_min": 18, "mode_creation": "ex_nihilo", "sources_inspiration": [], "fichier_tex": "chapitres/TCOMPL-MODELES-FONCTION/exercices/TCOMPL-MF-EX-040.tex", "corrige_tex": "chapitres/TCOMPL-MODELES-FONCTION/corriges/TCOMPL-MF-CO-040.tex", "status": "approved"}
% BEGIN-VERIFY
% from sympy import *
% x = symbols('x')
...
% END-VERIFY
\begin{exercice}{TCOMPL-MF-EX-040}{2}{18}
Soit $f(x) = \sqrt{1+x}$.
\begin{enumerate}
