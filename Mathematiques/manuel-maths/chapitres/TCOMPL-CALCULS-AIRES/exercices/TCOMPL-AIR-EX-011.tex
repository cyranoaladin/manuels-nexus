...
\begin{enumerate}
  \item Reconnaître, pour chacun des deux termes de $d$, la forme usuelle
    $\dfrac{u'}{u}$ ou $u'\mathrm{e}^{u}$ dont il relève. Préciser la fonction $u$
    dans chaque cas, sans calculer encore de primitive.
  \item Déterminer une primitive $D$ de $d$ sur $[0\,;\,10]$.
