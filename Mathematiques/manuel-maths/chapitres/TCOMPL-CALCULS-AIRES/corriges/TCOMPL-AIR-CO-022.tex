% META: {"id": "TCOMPL-AIR-CO-022", "chapitre": "TCOMPL-CALCULS-AIRES", "type_objet": "corrige", "exercice_ref": "TCOMPL-AIR-EX-022", "capacites_codes": ["C4"], "sources_inspiration": [], "status": "approved"}
% BEGIN-VERIFY
% from sympy import *
% x, y, t = symbols('x y t')
...
% END-VERIFY
\begin{corrige}{TCOMPL-AIR-EX-022}
