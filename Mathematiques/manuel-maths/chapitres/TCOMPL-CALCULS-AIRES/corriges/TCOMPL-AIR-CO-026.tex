% META: {"id": "TCOMPL-AIR-CO-026", "chapitre": "TCOMPL-CALCULS-AIRES", "type_objet": "corrige", "exercice_ref": "TCOMPL-AIR-EX-026", "capacites_codes": ["C2"], "sources_inspiration": [], "status": "approved"}
% BEGIN-VERIFY
% from sympy import *
...
% END-VERIFY
\begin{corrige}{TCOMPL-AIR-EX-026}
