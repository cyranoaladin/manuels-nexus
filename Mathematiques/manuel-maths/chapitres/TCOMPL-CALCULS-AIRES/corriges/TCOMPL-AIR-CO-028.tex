% META: {"id": "TCOMPL-AIR-CO-028", "chapitre": "TCOMPL-CALCULS-AIRES", "type_objet": "corrige", "exercice_ref": "TCOMPL-AIR-EX-028", "capacites_codes": ["C4"], "sources_inspiration": [], "status": "approved"}
% BEGIN-VERIFY
% from sympy import *
% x = symbols('x')
% f = x**3 - 3*x
...
% assert f.subs(x, 1) == -2
% END-VERIFY
\begin{corrige}{TCOMPL-AIR-EX-028}
