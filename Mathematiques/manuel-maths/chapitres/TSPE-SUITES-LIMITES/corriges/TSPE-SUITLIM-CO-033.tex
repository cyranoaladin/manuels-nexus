...
\textbf{Q3.} En inversant l'inégalité précédente (tous les termes sont strictement positifs) :
\[
...
Or $\lim_{n \to +\infty} \dfrac{162}{n-1} = 0$. Par le théorème des gendarmes, $\boxed{\lim_{n \to +\infty} u_n = 0}$.
