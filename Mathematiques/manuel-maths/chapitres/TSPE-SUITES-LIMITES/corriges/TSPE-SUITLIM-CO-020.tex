% META: {"id": "TSPE-SUITLIM-CO-020", "chapitre": "TSPE-SUITES-LIMITES", "type_objet": "corrige", "exercice_ref": "TSPE-SUITLIM-EX-020", "capacites_codes": ["C1"], "sources_inspiration": [], "status": "approved"}
% BEGIN-VERIFY
% from sympy import *
% import math
% u = [2.0]
...
\textbf{Question 4.} Croissante majorée par $3$ : converge. $\ell = \sqrt{\ell+6}$, $\ell^2 = \ell+6$, $\ell = 3$ (car $\ell \geq 0$). $\boxed{\lim u_n = 3}$.
