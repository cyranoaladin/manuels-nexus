% META: {"id": "TSPE-SUITLIM-CO-009", "chapitre": "TSPE-SUITES-LIMITES", "type_objet": "corrige", "exercice_ref": "TSPE-SUITLIM-EX-009", "capacites_codes": ["C2"], "sources_inspiration": [], "status": "approved"}
% BEGIN-VERIFY
% from sympy import *
% for n in range(8):
...
\commentaireMarge{Récurrence sur une somme géométrique.}
...
\textbf{Conclusion.} Par récurrence, $\boxed{\sum_{k=0}^{n} 2^k = 2^{n+1} - 1}$ pour tout $n \in \mathbb{N}$.
