% META: {"id": "TSPE-SUITLIM-CO-013", "chapitre": "TSPE-SUITES-LIMITES", "type_objet": "corrige", "exercice_ref": "TSPE-SUITLIM-EX-013", "capacites_codes": ["C2"], "sources_inspiration": [], "status": "needs_review", "approval_state": "STALE_AFTER_SEMANTIC_EDIT"}
% BEGIN-VERIFY
% from sympy import *
% for m in range(1, 8):
...
\textit{Heredite.} Supposons $\mathcal{P}(n)$.
\begin{align*}
  \sum_{k=1}^{n+1} k^2
