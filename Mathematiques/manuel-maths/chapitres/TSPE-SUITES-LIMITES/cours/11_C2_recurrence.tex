...
\margeAppui{
\textbf{Structure de la redaction.} Ecrire explicitement la propriete $\mathcal{P}(n)$, puis \textbf{Initialisation}, \textbf{Heredite} (avec $n \geq n_0$ fixe) et \textbf{Conclusion}. Cette redaction structuree est exigee dans les copies de baccalaureat.
}
