% META: {"id": "TCOMPL-INEG-CO-022", "chapitre": "TCOMPL-INEGALITES", "type_objet": "corrige", "exercice_ref": "TCOMPL-INEG-EX-022", "capacites_codes": ["C2"], "sources_inspiration": [], "status": "approved"}
% BEGIN-VERIFY
% from sympy import *
% x, y, t = symbols('x y t')
...
% END-VERIFY
\begin{corrige}{TCOMPL-INEG-EX-022}
