...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item \textbf{C} — Modèle avec capacité d'accueil. Le modèle de Malthus s'écrit y'=ay : le coefficient de croissance a est constant et la variation est proportionnelle à la population. \emph{Renvoi : C5.}
  \end{itemize}
  \item \textbf{Q5}
  \begin{itemize}
