...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item \textbf{C} — L'élève a transforme l'inégalité triangulaire $\Vert\vec u+\vec v\Vert\leqslant\Vert\vec u\Vert+\Vert\vec v\Vert$ en égalité et obtenu $3+4=7$ ; l'égalité n'est pas justifiee ici. \emph{Renvoi : M2.}
