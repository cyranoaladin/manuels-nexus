...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item \textbf{C} — Les deux normes valent $\sqrt{13}$ ; elles ne sont donc pas differentes. Leur produit scalaire nul etablit l'orthogonalite. \emph{Renvoi : M3.}
    \item \textbf{D} — Deux vecteurs de sens contraire sont colineaires avec un coefficient negatif ; ici leur determinant vaut $-13$, donc ils ne sont pas colineaires. \emph{Renvoi : M3.}
  \end{itemize}
  \item \textbf{Q9}
  \begin{itemize}
