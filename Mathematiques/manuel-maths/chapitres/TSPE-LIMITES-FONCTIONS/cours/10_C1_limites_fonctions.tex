...
\margeAppui{
\textbf{Strategie face a une forme indeterminee :} polynome, factoriser par le terme de plus haut degre ; fraction rationnelle, factoriser numerateur et denominateur par le terme dominant ; avec $\mathrm{e}^x$, factoriser par $\mathrm{e}^x$ et utiliser les croissances comparees ; en un point, factoriser, simplifier, ou utiliser le taux de variation.
}
