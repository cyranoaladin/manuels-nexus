...
Soit $f(x) = \dfrac{3x+1}{x-2}$ définie sur $\mathbb{R} \setminus \{2\}$.
\begin{enumerate}
  \item Déterminer les limites de $f$ en $+\infty$ et en $-\infty$.
  \item Déterminer les limites de $f$ en $2^+$ et $2^-$.
