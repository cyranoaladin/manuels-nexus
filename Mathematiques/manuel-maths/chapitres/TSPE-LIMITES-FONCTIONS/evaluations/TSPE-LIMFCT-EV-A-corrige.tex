% META: {"id": "TSPE-LIMFCT-EV-A-corrige", "chapitre": "TSPE-LIMITES-FONCTIONS", "type_objet": "corrige_evaluation", "evaluation_ref": "TSPE-LIMFCT-EV-A", "version": "A", "capacites_codes": ["C1", "C2", "C3"], "sources_inspiration": [], "status": "approved"}
% BEGIN-VERIFY
% from sympy import *
% x = symbols('x')
%
...
\textbf{Corrige de l'évaluation A — TSPE-LIMFCT-EV-A}
...
\textbf{2.} Numérateur en $1$ : $2+5 = 7 > 0$. Dénominateur $x-1$.
...
\textbf{3.} $f'(x) = 0 \iff x = -1$ ou $x = 3$. Signe de $-(x-3)(x+1)$ : positif sur $]-1, 3[$, négatif ailleurs.

$f$ décroissante sur $]-\infty, -1]$, croissante sur $[-1, 3]$, décroissante sur $[3, +\infty[$.
