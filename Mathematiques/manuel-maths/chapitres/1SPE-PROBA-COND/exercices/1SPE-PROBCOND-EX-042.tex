...
\begin{enumerate}
  \item Calculer la probabilité qu'une ampoule soit defectueuse.
  \item Une ampoule est defectueuse. Calculer la probabilité qu'elle vienne de la ligne $B$.
\end{enumerate}
\end{exercice}
