...
\begin{enumerate}
  \item Calculer la probabilité que les deux pieces soient defectueuses.
  \item Calculer la probabilité qu'au moins une piece soit defectueuse.
