...
\item \textbf{[Q17]} Un test a une sensibilite de 99 %, une specificite de 99 % et la prevalence est de 0,1 %. Sa valeur predictive positive est environ :
  \begin{enumerate}[label=\Alph*.]
    \item proche de 99 %
    \item proche de 50 %
    \item proche de 9 %
...
\begin{itemize}
  ...
  \item \textbf{Q8}
  \begin{itemize}
    \item \textbf{A} — L'eleve a repris directement $P_{\overline B}(A)=1/4$ sans ponderer par $P(\overline B)=2/3$ ni ajouter la branche $B$. \emph{Renvoi : C3, formule.}
    \item \textbf{B} — L'eleve a calcule seulement la branche $P(B)P_B(A)=1/6$ et a oublie la branche complementaire. \emph{Renvoi : C3, formule.}
    \item \textbf{C} — L'eleve a additionne $P(B)P_B(A)=1/6$ et la probabilite conditionnelle $1/4$ sans la ponderer par $P(\overline B)=2/3$. \emph{Renvoi : C3, formule.}
  \end{itemize}
  \item \textbf{Q9}
  \begin{itemize}
  ...
  \item \textbf{Q17}
  \begin{itemize}
    \item \textbf{A} — La sensibilite n'est pas la valeur predictive positive. La tres faible prevalence rend les faux positifs nombreux relativement aux vrais positifs. \emph{Renvoi : C5, VPP et prevalence.}
    \item \textbf{B} — Le calcul donne $0{,}00099/(0{,}00099+0{,}00999)\approx0{,}090$, donc environ 9 %, pas 50 %. \emph{Renvoi : C5, VPP et prevalence.}
    \item \textbf{D} — La valeur predictive positive n'est pas la prevalence : elle rapporte les vrais positifs a l'ensemble des tests positifs. \emph{Renvoi : C5, formule de Bayes.}
  \end{itemize}
  \item \textbf{Q18}
  \begin{itemize}
