...
\begin{itemize}
  ...
  \item \textbf{Q11}
  \begin{itemize}
    \item \textbf{A} — $f'(x)=0$ caracterise un point critique lorsque $f$ est derivable, pas un changement de convexite. \emph{Renvoi : cours C4, definition.}
    \item \textbf{C} — $f''(x)=0$ ne suffit pas : par exemple $f(x)=x^4$ verifie $f''(0)=0$ sans changer de convexite en 0. \emph{Renvoi : cours C4, point d'inflexion.}
    \item \textbf{D} — $f(x)=0$ indique une intersection avec l'axe des abscisses, sans information sur la convexite. \emph{Renvoi : cours C4, definition.}
  \end{itemize}
  \item \textbf{Q12}
  \begin{itemize}
    \item \textbf{B} — Consulter le cours correspondant \emph{Renvoi : M1.}
