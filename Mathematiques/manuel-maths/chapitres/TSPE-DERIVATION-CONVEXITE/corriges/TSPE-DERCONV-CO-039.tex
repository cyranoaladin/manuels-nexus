% META: {"id": "TSPE-DERCONV-CO-039", "chapitre": "TSPE-DERIVATION-CONVEXITE", "type_objet": "corrige", "exercice_ref": "TSPE-DERCONV-EX-039", "capacites_codes": ["C5"], "sources_inspiration": [], "status": "generated"}
% BEGIN-VERIFY
% from sympy import *
% x = symbols('x')
% f = ln(x)
...
% END-VERIFY
\begin{corrige}{TSPE-DERCONV-EX-039}
