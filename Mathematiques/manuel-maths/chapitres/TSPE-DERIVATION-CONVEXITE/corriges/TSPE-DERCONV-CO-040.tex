% META: {"id": "TSPE-DERCONV-CO-040", "chapitre": "TSPE-DERIVATION-CONVEXITE", "type_objet": "corrige", "exercice_ref": "TSPE-DERCONV-EX-040", "capacites_codes": ["C5"], "sources_inspiration": [], "status": "approved"}
% BEGIN-VERIFY
% from sympy import *
% x = symbols('x')
...
% END-VERIFY
\begin{corrige}{TSPE-DERCONV-EX-040}

\textbf{Question 1.} $f(0)=1$, $f'(x) = \dfrac{1}{2\sqrt{1+x}}$, $f'(0) = \dfrac{1}{2}$.

\commentaireMarge{$\sqrt{1+x}$ concave ($f''<0$) : la tangente majoré la courbe.}
