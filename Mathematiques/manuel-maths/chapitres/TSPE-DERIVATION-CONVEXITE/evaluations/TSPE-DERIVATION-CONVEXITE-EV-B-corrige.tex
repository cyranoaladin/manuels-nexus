% META: {"id": "TSPE-DERIVATION-CONVEXITE-EV-B-corrige", "chapitre": "TSPE-DERIVATION-CONVEXITE", "type_objet": "corrige_evaluation", "evaluation_ref": "TSPE-DERIVATION-CONVEXITE-EV-B", "version": "B", "capacites_codes": ["C1","C2","C3","C4","C5","C6"], "sources_inspiration": [], "status": "generated"}
% BEGIN-VERIFY
% from sympy import *
% x = symbols('x')
%
