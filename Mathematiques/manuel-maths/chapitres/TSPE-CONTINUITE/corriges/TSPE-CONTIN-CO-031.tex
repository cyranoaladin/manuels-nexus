...
\textbf{Q1.} On factorise par le terme de plus haut degré : $P(x) = x^3\left(1 - \dfrac{4}{x^2} + \dfrac{1}{x^3}\right)$. Le second facteur tend vers $1$ en $\pm\infty$. Donc $\displaystyle\lim_{x \to -\infty}P(x) = -\infty$ et $\displaystyle\lim_{x \to +\infty}P(x) = +\infty$.

Comme $P$ tend vers $-\infty$, il existe un réel $a$ tel que $P(a) < 0$ ; comme $P$ tend vers $+\infty$, il existe $b > a$ tel que $P(b) > 0$. La fonction $P$ est continue sur $[a\,;b]$ (fonction polynôme) et $0$ est compris entre $P(a)$ et $P(b)$ : d'après le théorème des valeurs intermediaires, il existe $c \in \left]a\,;b\right[$ tel que $P(c) = 0$.

\textbf{Q2.} $P'(x) = 3x^2 - 4$, qui s'annule en $\pm\dfrac{2}{\sqrt{3}}$. La fonction croit jusqu'a $-\dfrac{2}{\sqrt{3}}$, décroît jusqu'a $\dfrac{2}{\sqrt{3}}$, puis croit. Comme $P\!\left(-\tfrac{2}{\sqrt3}\right) > 0$ et $P\!\left(\tfrac{2}{\sqrt3}\right) < 0$, chacune des trois branches strictement monotones traverse la valeur $0$ exactement une fois : $P$ a \textbf{trois} racines réelles, approximativement $-2{,}115$, $0{,}254$ et $1{,}861$.
