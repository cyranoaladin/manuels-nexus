...
\begin{enumerate}
  ...
  \item Montrer que $f(x) - x$ est du signe de $-(x-4)(x+1)$ sur $[0\,;4]$, et en déduire le sens de variation de $(u_n)$.
  \item Déterminer la limite de $(u_n)$ en justifiant chaque étape.
\end{enumerate}
\end{exercice}
