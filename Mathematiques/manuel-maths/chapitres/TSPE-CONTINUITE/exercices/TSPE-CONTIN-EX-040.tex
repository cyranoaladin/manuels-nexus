...
\begin{enumerate}
  \item Calculer $u_1$, $u_2$ et $u_3$ sous forme décimale exacte.
  \item Résoudre $f(x) = x$ et donner les points fixes de $f$.
  \item Montrer que, pour tout $x \in [0\,;1]$, $f(x) \in [0\,;1]$. En déduire que $0 \leq u_n \leq 1$ pour tout $n$.
  \item Montrer que $f(x) - x = x(1-x)$ et en déduire le sens de variation de $(u_n)$.
  \item Déterminer la limite de $(u_n)$ en justifiant l'elimination de l'autre point fixe.
\end{enumerate}
\end{exercice}
