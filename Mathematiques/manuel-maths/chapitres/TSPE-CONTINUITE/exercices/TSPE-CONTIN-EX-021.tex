...
La concentration d'un medicament dans le sang, en mg$\cdot$L$^{-1}$, $t$ heures après la prise, est modélisée sur $[2\,;8]$ par
\[ c(t) = t\,\mathrm{e}^{-t/2}. \]
\begin{enumerate}
  \item Montrer que $c'(t) = \dfrac{(2-t)\,\mathrm{e}^{-t/2}}{2}$ et en déduire le sens de variation de $c$ sur $[2\,;8]$.
