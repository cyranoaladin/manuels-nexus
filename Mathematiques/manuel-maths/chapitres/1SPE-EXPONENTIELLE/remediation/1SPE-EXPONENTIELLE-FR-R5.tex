% META: {"id":"1SPE-EXPONENTIELLE-FR-R5","chapitre":"1SPE-EXPONENTIELLE","type_objet":"remediation","status":"approved","prerequis_testes":["R5"],"origin":"generated","status_history":["generated","audited","accepted","approved"],"release_acceptance":"RELEASE_OWNER_BATCH_ACCEPTANCE","acceptance_closure_digest":"sha256:9b3ccf9a81c5520fbb7e03b7b2d3e7bf2057a02834b6d908bf3be5f49f3b553f","acceptance_receipt_digest":"sha256:4fad86f0282e0fa4e0419cca1ad6379ae7af5a280c04a4a90880f90a1c044242"}

%---------------------------------------------------------------
% FICHE DE REMISE A NIVEAU — R5 : Suites géométriques
% Prerequis issu de 1SPE-SUITES
%---------------------------------------------------------------

\subsection*{Rappel — Suites géométriques et coefficient multiplicateur}

Une suite $(u_n)$ est \textbf{géométrique} de raison $q$ si pour tout $n$ : $u_{n+1} = q \times u_n$.

Formule explicite : $u_n = u_0 \times q^n$.

Lien avec l'exponentielle : la suite $u_n = u_0 \times \mathrm{e}^{rn}$ est géométrique de raison $q = \mathrm{e}^r$, car $u_{n+1} = u_0 \times \mathrm{e}^{r(n+1)} = \mathrm{e}^r \times u_n$.
...
Un capital de $1\,000$~euros est place a un taux annuel de $3\,\%$. On note $C_n$ le capital au bout de $n$ années.
\begin{enumerate}
...
\textbf{Question 2.} $(C_n)$ est géométrique de raison $1{,}03$ et $C_0 = 1000$.
\[
...
Une population de bacteries est modélisée par $P_n = 500 \times (1{,}5)^n$ ou $n$ est le nombre d'heures.
\begin{enumerate}
  \item Justifier que $(P_n)$ est une suite géométrique. Donner sa raison.
