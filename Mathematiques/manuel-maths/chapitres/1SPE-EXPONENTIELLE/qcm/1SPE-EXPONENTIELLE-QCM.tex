...
\item \textbf{[Q1]} Parmi les propriétés suivantes, laquelle caracterise la fonction exponentielle ?
...
\item \textbf{[Q3]} Pour tout réel $x$, on a :
  \begin{enumerate}[label=\Alph*.]
    ...
    \item $\mathrm{e}^x$ peut etre négatif si $x < 0$
...
\begin{itemize}
  \item \textbf{Q1}
  \begin{itemize}
    \item \textbf{A} — La condition $f(1)=1$ définit la fonction $x\mapsto \mathrm{e}^{x-1}$, pas la fonction exponentielle $x\mapsto \mathrm{e}^x$, qui vérifie $f(0)=1$. \emph{Renvoi : M1, étape 1.}
  ...
  \begin{itemize}
    ...
    \item \textbf{B} — L'élève confond $\mathrm{e}^0$ et $\mathrm{e}^1$. On a $\mathrm{e}^1 = \mathrm{e}$ mais $\mathrm{e}^0 = 1$. \emph{Renvoi : M1, propriété fondamentale.}
  ...
  \begin{itemize}
    ...
    \item \textbf{C} — Pour $x < 0$, $\mathrm{e}^x$ est positif (par exemple $\mathrm{e}^{-1} = 1/\mathrm{e} \approx 0{,}37 > 0$). L'élève confond exposant négatif et résultat négatif. \emph{Renvoi : M1, étape 2.}
  ...
  \begin{itemize}
    ...
    \item \textbf{B} — L'élève a multiplie les exposants avec un signe négatif ($-7 \times 3 = -21$) au lieu de soustraire. \emph{Renvoi : M2, règle 2 ; R4.}
  ...
  \begin{itemize}
    ...
    \item \textbf{D} — La dérivée de l'exponentielle est $\exp(x) > 0$, donc la fonction est strictement croissante, certainement pas constante. \emph{Renvoi : M3, étape 1.}
  \end{itemize}
  \item \textbf{Q8}
  \begin{itemize}
    \item \textbf{A} — Un exposant négatif ne rend pas la valeur négative : $\mathrm{e}^x$ est strictement positif pour tout réel $x$. \emph{Renvoi : C3, signe de l'exponentielle.}
  ...
  \item \textbf{Q9}
  \begin{itemize}
    \item \textbf{B} — L'élève a mal compare les exposants. Or $2{,}5^2 = 6{,}25 < 7$ donc $2{,}5 < \sqrt{7}$, et par croissance de l'exponentielle, $\mathrm{e}^{2{,}5} < \mathrm{e}^{\sqrt{7}}$. \emph{Renvoi : M3, étape 3.}
  ...
  \begin{itemize}
    ...
    \item \textbf{C} — Le facteur $3$ est correct, mais la fonction exponentielle conserve la variable : $\mathrm{e}^{3t}$ ne devient pas $\mathrm{e}^3$. \emph{Renvoi : C4, dérivée de $t\mapsto\mathrm{e}^{at}$.}
  \end{itemize}
  \item \textbf{Q11}
  \begin{itemize}
    ...
    \item \textbf{B} — Le coefficient a pour valeur $-2$, pas $2$ : le signe négatif a ete perdu. \emph{Renvoi : C4, coefficient $a=-2$.}
    \item \textbf{D} — Le facteur $-2$ est correct, mais l'exposant reste $-2t$ : son signe ne change pas lors de la dérivation. \emph{Renvoi : C4, dérivée de $t\mapsto\mathrm{e}^{at}$.}
  \end{itemize}
  \item \textbf{Q12}
  \begin{itemize}
    \item \textbf{A} — L'élève a oublie le coefficient $0{,}5$ qui multiplie $t$ dans l'exposant. \emph{Renvoi : C4, coefficient $a=0{,}5$.}
  ...
  \begin{itemize}
    ...
    \item \textbf{D} — $0{,}2$ est le taux continu du modele ; ce n'est pas la valeur de la population. \emph{Renvoi : C5, paramètres du modele.}
  \end{itemize}
  \item \textbf{Q14}
  \begin{itemize}
    \item \textbf{B} — Le signe de l'exposant a ete inverse : le modele de décroissance conserve le facteur $\mathrm{e}^{-0{,}3}$ d'une unite de temps a la suivante. \emph{Renvoi : C5, décroissance exponentielle.}
  ...
  \begin{itemize}
    ...
    \item \textbf{D} — Une exponentielle est toujours strictement positive, y compris lorsque son exposant est négatif. \emph{Renvoi : C3, signe ; C5, décroissance.}
  \end{itemize}
\end{itemize}
\fi
