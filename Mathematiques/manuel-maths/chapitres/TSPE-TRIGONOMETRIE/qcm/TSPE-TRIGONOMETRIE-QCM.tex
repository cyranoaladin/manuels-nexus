...
\begin{itemize}
  ...
  \item \textbf{Q2}
  \begin{itemize}
    \item \textbf{A} — Le signe moins appartient a la formule $(\cos x)'=-\sin x$ ; la dérivée de $\sin x$ est $\cos x$ sans changement de signe.
  ...
  \begin{itemize}
    ...
    \item \textbf{C} — Le facteur $3$ est present, mais l'argument de la fonction cosinus doit rester $3x$ après dérivation de la composee.
