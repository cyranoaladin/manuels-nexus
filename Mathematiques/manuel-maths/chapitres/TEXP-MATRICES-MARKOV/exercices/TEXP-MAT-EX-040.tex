% META: {"id": "TEXP-MAT-EX-040", "chapitre": "TEXP-MATRICES-MARKOV", "type_objet": "exercice", "capacites": ["TEXP-MAT-C5"], "capacites_codes": ["C5"], "methodes": ["M4"], "parcours": 2, "competences": ["raisonner"], "duree_min": 18, "mode_creation": "ex_nihilo", "sources_inspiration": [], "fichier_tex": "chapitres/TEXP-MATRICES-MARKOV/exercices/TEXP-MAT-EX-040.tex", "corrige_tex": "chapitres/TEXP-MATRICES-MARKOV/corriges/TEXP-MAT-CO-040.tex", "status": "approved"}
% BEGIN-VERIFY
% from sympy import *
% x = symbols('x')
...
% END-VERIFY
\begin{exercice}{TEXP-MAT-EX-040}{2}{18}
Soit $f(x) = \sqrt{1+x}$.
\begin{enumerate}
