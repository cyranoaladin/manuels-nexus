...
\item \textbf{[Q4]} Une suite de matrices colonnes verifie $U_{n+1}=AU_n+C$. Une solution constante $U$ satisfait :
  \begin{enumerate}[label=\Alph*.]
    \item $AU=C$
    \item $(I-A)U=C$
    \item $U=A+C$
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item \textbf{C} — Les probabilites sont positives. Avec la convention des distributions lignes, chaque ligne d'une matrice de transition contient des probabilités dont la somme vaut 1. \emph{Renvoi : C4.}
