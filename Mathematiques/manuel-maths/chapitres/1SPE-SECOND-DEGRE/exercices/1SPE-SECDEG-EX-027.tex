...
% # V(x) = x * A(x), maximum exact en x=2 sur le domaine physique
...
\begin{enumerate}
  ...
  \item Montrer que $V(x) = 4x^3 - 52x^2 + 160x$.
  ...
  \end{enumerate}
  \item Calculer $V(2)$ et $V(3)$. Quel découpage donne le plus grand volume ?
\end{enumerate}
\end{exercice}
