...
% assert Delta_m2 == 0
% x0 = Rational(2*(-2), 2)  # racine double m=-2, lue dans (x+2)^2
% assert x0 == -2
...
% assert set(sols) == {-1, 2}
% # Forme canonique par identité remarquable.
% assert expand(f-((x-m)**2-m-2)) == 0
% END-VERIFY
