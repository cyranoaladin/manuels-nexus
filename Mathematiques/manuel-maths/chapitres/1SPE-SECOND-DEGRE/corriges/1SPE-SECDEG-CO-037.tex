...
\commentaireMarge{Compléter le carré dans $x^2-10x$.}
...
La contrainte de la question 3 est levée : les dimensions sont positives
exactement pour $0<x<20$.

L'aire devient :
\[B(x) = x \cdot y = x\!\left(10 - \frac{x}{2}\right) = 10x - \frac{x^2}{2}.\]

On complète le carré :
\[B(x)=-\frac{1}{2}(x^2-20x)
=-\frac{1}{2}\bigl((x-10)^2-100\bigr)=-\frac{1}{2}(x-10)^2+50.\]
Le maximum $50$~m$^2$ est atteint pour $x=10$, qui appartient à $]0\,;\,20[$.
