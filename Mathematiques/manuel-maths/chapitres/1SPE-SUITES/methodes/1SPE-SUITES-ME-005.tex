...
\textbf{Conclusion.} On a $u_0>u_1>u_2$ : la suite $(u_n)$ est
\textbf{strictement décroissante jusqu'au rang $2$}. Elle est ensuite
\textbf{strictement croissante à partir du rang $2$}. Elle n'est pas monotone
sur $\mathbb{N}$ tout entier.
