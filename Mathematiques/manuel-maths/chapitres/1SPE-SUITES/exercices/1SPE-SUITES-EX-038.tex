...
\begin{enumerate}
  ...
  \begin{enumerate}
    ...
    \item À l'aide d'une calculatrice, d'un tableau de valeurs ou d'essais successifs, calculer $V_5$ et $V_6$, arrondies à l'euro, puis identifier le premier anniversaire auquel la valeur est inférieure à $9\,000$~\euro{}.
    \item Conclure : à quel anniversaire Théo doit-il vendre au plus tard son véhicule ?
  \end{enumerate}
\end{enumerate}
\end{exercice}
