...
\begin{enumerate}
  ...
  \item Compléter et expliquer le programme Python ci-dessous, qui détermine
  ...
  \item Donner le rang obtenu, puis montrer que cet avantage est ensuite
  conservé en comparant les accroissements mensuels des deux offres.
\end{enumerate}
...
\textbf{Question 2.} On sait par la question 1 que l'offre A est en tête au
rang $6$ ; on initialise au rang $10$ afin de chercher le croisement beaucoup
plus tardif. La boucle \texttt{while B <= A} tourne tant que l'offre B n'a pas
repris l'avantage. À chaque itération, on incrémente $n$ puis on recalcule les
...
\begin{enumerate}
  ...
  partie C garantit que l'offre B conserve son avance après le rang $1\,415$.
  \item \pictoOral{} \textit{Question orale.} « Expliquer en quelques phrases
  les deux croisements observés entre les offres. Quel rôle jouent le capital
...
\textbf{Conclusion :} Sur les horizons de $5$ et $10$ ans étudiés, l'offre A
est plus avantageuse. Le programme vérifie aussi $A_n\geqslant B_n$ pour les
rangs testés de $10$ à $1\,414$.

\textbf{Question 2.} Au rang $1\,415$, l'offre B est devant. À partir de ce
