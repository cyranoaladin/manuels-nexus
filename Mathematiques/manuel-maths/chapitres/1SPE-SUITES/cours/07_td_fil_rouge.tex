...
\commentaireMarge{L'avance de l'offre B au tout début n'est qu'un effet du capital initial : elle disparaît presque aussitôt.}
...
\commentaireMarge{À ces rangs, l'offre A domine très largement : l'écart se creuse encore avant de se résorber sur le très long terme.}
...
\commentaireMarge{Esprit critique : un résultat mathématiquement exact peut être hors de portée pratique. Sur tout horizon raisonnable (une vie d'épargne, soit quelques dizaines d'années), l'offre A reste imbattable.}
