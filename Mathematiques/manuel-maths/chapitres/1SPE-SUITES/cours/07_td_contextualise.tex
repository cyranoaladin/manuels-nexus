...
\textbf{Question 4.} Le plus petit entier $n$ tel que $M_n \leq 50$ est $n = 57$. La demi-vie est donc de $\mathbf{57}$ siècles, soit $\mathbf{5\,700}$ ans.

\commentaireMarge{La demi-vie réelle du carbone-14 est de 5 730 ans. Notre modèle avec $q = 0{,}9879$ donne 5 700 ans, ce qui est une excellente approximation.}
