% META: {"id": "1SPE-SUITES-FR-R2", "chapitre": "1SPE-SUITES", "type_objet": "remediation", "status": "generated", "prerequis_testes": ["R2"]}
...
\commentaireMarge{Formule d'une suite géométrique : $n$ applications du CM depuis $C_0$.}
...
Une population de bactéries double toutes les heures. Au départ, on compte $500$ bactéries.
\begin{enumerate}
