% META: {"id": "TSPE-PROBA-EV-A-corrige", "chapitre": "TSPE-PROBABILITES", "type_objet": "corrige_evaluation", "evaluation_ref": "TSPE-PROBA-EV-A", "version": "A", "capacites_codes": ["C1", "C2", "C4", "C5", "C9"], "sources_inspiration": [], "status": "needs_review", "approval_state": "STALE_AFTER_SEMANTIC_EDIT"}
% BEGIN-VERIFY
