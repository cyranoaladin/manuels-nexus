...
\item \textbf{[Q1]} Le nombre $X$ de succes dans $n$ repetitions independantes d'une meme epreuve de probabilite de succes $p$ suit :
...
\item \textbf{[Q5]} Quelle expression Python renvoie la moyenne d'un echantillon de $n$ variables de Bernoulli de parametre $p$ ?
  \begin{enumerate}[label=\Alph*.]
