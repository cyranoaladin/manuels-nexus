% META: {"id": "1SPE-TRIGO-EV-A-corrige", "chapitre": "1SPE-TRIGONOMETRIE", "type_objet": "corrige_evaluation", "evaluation_ref": "1SPE-TRIGO-EV-A", "version": "A", "capacites_codes": ["C1","C2","C3","C4","C5"], "sources_inspiration": [], "parametres_sympy": {}, "fichier_tex": "chapitres/1SPE-TRIGONOMETRIE/evaluations/1SPE-TRIGO-EV-A-corrige.tex", "status": "approved"}
% BEGIN-VERIFY
% from sympy import *
