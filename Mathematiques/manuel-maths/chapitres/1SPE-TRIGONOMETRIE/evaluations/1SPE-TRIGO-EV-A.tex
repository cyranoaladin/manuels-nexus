...
\begin{enumerate}
  ...
  \item Quelle fraction d'un tour complet represente un angle de $\dfrac{7\pi}{6}$ radians ? \hfill (1 pt)
\end{enumerate}
...
\begin{enumerate}
  \item Donner les coordonnees du point image de $-\dfrac{\pi}{3}$. \hfill (1,5 pt)
  \item Donner les coordonnees du point image de $\dfrac{3\pi}{4}$. \hfill (1,5 pt)
...
\begin{enumerate}
  ...
  \item Donner les coordonnees du point du cercle trigonometrique associe a $\dfrac{\pi}{3}$. \hfill (1 pt)
  \item En deduire la hauteur exacte du passager au-dessus du sol. \hfill (1,5 pt)
