% META: {"id": "TCOMPL-CORR-CO-026", "chapitre": "TCOMPL-CORRELATION-CAUSALITE", "type_objet": "corrige", "exercice_ref": "TCOMPL-CORR-EX-026", "capacites_codes": ["C1"], "sources_inspiration": [], "status": "approved"}
% BEGIN-VERIFY
% from sympy import *
...
% END-VERIFY
\begin{corrige}{TCOMPL-CORR-EX-026}
