% META: {"id": "TCOMPL-CORR-CO-022", "chapitre": "TCOMPL-CORRELATION-CAUSALITE", "type_objet": "corrige", "exercice_ref": "TCOMPL-CORR-EX-022", "capacites_codes": ["C2"], "sources_inspiration": [], "status": "approved"}
% BEGIN-VERIFY
% from sympy import *
% x, y, t = symbols('x y t')
...
% END-VERIFY
\begin{corrige}{TCOMPL-CORR-EX-022}
