% META: {"id": "TCOMPL-CORR-CO-028", "chapitre": "TCOMPL-CORRELATION-CAUSALITE", "type_objet": "corrige", "exercice_ref": "TCOMPL-CORR-EX-028", "capacites_codes": ["C3"], "sources_inspiration": [], "status": "approved"}
% BEGIN-VERIFY
% from sympy import *
% x = symbols('x')
% f = x**3 - 3*x
...
% assert f.subs(x, 1) == -2
% END-VERIFY
\begin{corrige}{TCOMPL-CORR-EX-028}
