...
Dernière consolidation : 16 juillet 2026.
...
- Mathématiques : commits `7d5f60b`, `d69948f`, rapports de LOT présents dans les trois
  répertoires de chapitres et tags `chap/1SPE-SUITES-v1`, `chap/1SPE-SECOND-DEGRE-v1`.
- NSI : commits `233c39b` (pilote) et `9da092e` (charte v3.2) ; `DIRECTIVES_EN_COURS.md`
  signale uniquement la validation humaine conjointe comme pause.
