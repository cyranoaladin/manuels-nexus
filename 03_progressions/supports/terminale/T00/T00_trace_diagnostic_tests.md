---
title: "T00 - Trace - Diagnostic tests"
level: "terminale"
sequence_id: "T00"
document_type: "trace"
status: "needs_review"
...
# T00 - Trace écrite - Diagnostic tests
...
### Repère 1 - maximum nominal
- À retenir : parcourir la liste en conservant le meilleur élément.
- Exemple minimal : `[3, 7, 2]` donne `7`.
- Vigilance : contrôler « liste d’un élément ».
- Question flash : que devient la méthode si la donnée change légèrement ?
### Repère 2 - liste vide
- À retenir : refuser l’entrée avant le parcours.
- Exemple minimal : `[]` donne exception documentée.
- Vigilance : contrôler « aucune valeur initiale ».
- Question flash : que devient la méthode si la donnée change légèrement ?
### Repère 3 - assertion
- À retenir : traduire une exigence en test exécutable.
- Exemple minimal : `assert maximum([1]) == 1` donne test passant.
- Vigilance : contrôler « message utile en cas d’échec ».
- Question flash : que devient la méthode si la donnée change légèrement ?
### Repère 4 - entrée invalide
- À retenir : définir si le mélange de types est autorisé.
- Exemple minimal : `[1, "x"]` donne erreur contrôlée.
- Vigilance : contrôler « comparaison impossible ».
- Question flash : que devient la méthode si la donnée change légèrement ?
## Exercices numérotés
