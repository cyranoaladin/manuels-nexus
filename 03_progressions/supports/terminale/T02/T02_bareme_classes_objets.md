---
title: "T02 - Bareme - Classes et objets"
level: "terminale"
sequence_id: "T02"
...
### Barème question 1
- 1 point : identifier correctement constructeur et la donnée `Compte("Ada", 20)`.
- 1 point : appliquer la méthode « initialiser les attributs après validation ».
- 1 point : obtenir propriétaire Ada, solde 20.
- 1 point : contrôler le cas limite « solde initial négatif » ou expliquer pourquoi il ne s’applique pas.
- Retrait possible : confusion avec l’erreur fréquente EF1 - Modifier directement un attribut sans passer par la méthode.
### Barème question 2
- 1 point : identifier correctement méthode dépôt et la donnée dépôt de 15.
- 1 point : appliquer la méthode « vérifier le montant puis modifier le solde ».
- 1 point : obtenir solde augmenté de 15.
- 1 point : contrôler le cas limite « montant nul ou négatif » ou expliquer pourquoi il ne s’applique pas.
- Retrait possible : confusion avec l’erreur fréquente EF2 - Oublier de maintenir l’invariant.
### Barème question 3
- 1 point : identifier correctement méthode retrait et la donnée retrait de 7 sur solde 20.
- 1 point : appliquer la méthode « contrôler disponibilité puis soustraire ».
- 1 point : obtenir solde 13.
- 1 point : contrôler le cas limite « retrait supérieur au solde » ou expliquer pourquoi il ne s’applique pas.
- Retrait possible : confusion avec l’erreur fréquente EF3 - Utiliser une variable globale pour l’état de l’objet.
### Barème question 4
- 1 point : identifier correctement représentation et la donnée `repr(compte)`.
- 1 point : appliquer la méthode « exposer une chaîne utile sans révéler de données inutiles ».
- 1 point : obtenir résumé lisible.
- 1 point : contrôler le cas limite « nom vide » ou expliquer pourquoi il ne s’applique pas.
- Retrait possible : confusion avec l’erreur fréquente EF4 - Confondre classe et instance.
## Exercices numérotés
