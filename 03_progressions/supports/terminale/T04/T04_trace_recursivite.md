...
### Repère 1 - factorielle
- À retenir : appliquer `n * fact(n-1)` jusqu’au cas `0!`.
- Exemple minimal : `4!` donne `24`.
- Vigilance : contrôler « entier négatif refusé ».
- Question flash : que devient la méthode si la donnée change légèrement ?
### Repère 2 - somme de liste
- À retenir : séparer tête et reste.
- Exemple minimal : `[4, 1, 3]` donne `8`.
- Vigilance : contrôler « liste vide ».
- Question flash : que devient la méthode si la donnée change légèrement ?
### Repère 3 - longueur
- À retenir : ajouter 1 à la longueur du reste.
- Exemple minimal : `["a", "b"]` donne `2`.
- Vigilance : contrôler « reste vide ».
- Question flash : que devient la méthode si la donnée change légèrement ?
### Repère 4 - terminaison
- À retenir : montrer une mesure entière strictement décroissante.
- Exemple minimal : `n` décroît vers 0 donne preuve de terminaison.
- Vigilance : contrôler « appel avec même argument ».
- Question flash : que devient la méthode si la donnée change légèrement ?
## Exercices numérotés
