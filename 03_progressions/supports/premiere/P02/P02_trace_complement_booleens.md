---
title: "P02 - Trace - Complément à deux et booléens"
level: "premiere"
sequence_id: "P02"
document_type: "trace"
status: "needs_review"
...
# P02 - Trace écrite - Complément à deux et booléens
...
### Repère 1 - décodage signé
- À retenir : lire le bit de signe puis soustraire `2^8` à la valeur naturelle.
- Exemple minimal : `11110110` sur 8 bits donne `-10`.
- Vigilance : contrôler « bit de poids fort à 1 ».
- Question flash : que devient la méthode si la donnée change légèrement ?
### Repère 2 - bornes sur n bits
- À retenir : calculer `-2^(n-1)` et `2^(n-1)-1`.
- Exemple minimal : `n = 4` bits signés donne `[-8 ; 7]`.
- Vigilance : contrôler « asymétrie entre minimum et maximum ».
- Question flash : que devient la méthode si la donnée change légèrement ?
### Repère 3 - encodage négatif
- À retenir : partir de 6, inverser les bits puis ajouter 1.
- Exemple minimal : `-6` sur 8 bits donne `11111010`.
- Vigilance : contrôler « retenue finale ignorée sur la largeur fixée ».
- Question flash : que devient la méthode si la donnée change légèrement ?
### Repère 4 - simplification booléenne
- À retenir : dresser les quatre lignes de vérité.
- Exemple minimal : `(a and b) or (a and not b)` donne `a`.
- Vigilance : contrôler « un exemple ne prouve pas une identité ».
- Question flash : que devient la méthode si la donnée change légèrement ?
## Exercices numérotés
