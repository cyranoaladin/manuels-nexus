---
title: "P01 - Trace - Conversions entre bases"
level: "premiere"
sequence_id: "P01"
document_type: "trace"
status: "needs_review"
...
# P01 - Trace écrite - Conversions entre bases
...
### Repère 1 - décimal vers binaire
- À retenir : enchaîner divisions par 2 puis lire les restes de bas en haut.
- Exemple minimal : `13` en base dix donne `1101₂`.
- Vigilance : contrôler « 0 se code 0 ».
- Question flash : que devient la méthode si la donnée change légèrement ?
### Repère 2 - binaire vers décimal
- À retenir : additionner les poids `32 + 8 + 4 + 1`.
- Exemple minimal : `101101₂` donne `45`.
- Vigilance : contrôler « un seul bit à 1 ».
- Question flash : que devient la méthode si la donnée change légèrement ?
### Repère 3 - binaire vers hexadécimal
- À retenir : séparer `1111` et `0000`, puis traduire chaque paquet.
- Exemple minimal : `11110000₂` donne `F0₁₆`.
- Vigilance : contrôler « complément à gauche si le nombre de bits n’est pas multiple de 4 ».
- Question flash : que devient la méthode si la donnée change légèrement ?
### Repère 4 - décimal vers hexadécimal
- À retenir : diviser par 16 et lire les restes avec les symboles A à F.
- Exemple minimal : `255` donne `FF₁₆`.
- Vigilance : contrôler « chiffre hexadécimal maximal F ».
- Question flash : que devient la méthode si la donnée change légèrement ?
## Exercices numérotés
