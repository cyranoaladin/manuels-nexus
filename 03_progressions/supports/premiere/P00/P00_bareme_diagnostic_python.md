---
title: "P00 - Bareme - Diagnostic Python"
level: "premiere"
sequence_id: "P00"
...
### Barème question 1
- 1 point : identifier correctement trace d’affectation et la donnée `x = 4 ; x = x + 3 ; print(x)`.
- 1 point : appliquer la méthode « dresser une table instruction, expression calculée, nouvelle valeur ».
- 1 point : obtenir `7` affiché.
- 1 point : contrôler le cas limite « variable réaffectée deux fois » ou expliquer pourquoi il ne s’applique pas.
- Retrait possible : confusion avec l’erreur fréquente EF1 - Lire le signe égal comme une égalité mathématique permanente.
### Barème question 2
- 1 point : identifier correctement concaténation de chaînes et la donnée `mot = "NS" ; mot = mot + "I"`.
- 1 point : appliquer la méthode « identifier le type chaîne puis appliquer `+` comme concaténation ».
- 1 point : obtenir `"NSI"`.
- 1 point : contrôler le cas limite « addition impossible entre chaîne et entier » ou expliquer pourquoi il ne s’applique pas.
- Retrait possible : confusion avec l’erreur fréquente EF2 - Confondre affichage et valeur retournée par une fonction.
### Barème question 3
- 1 point : identifier correctement test conditionnel et la donnée `n = 6 ; n % 2 == 0`.
- 1 point : appliquer la méthode « calculer le reste puis évaluer le booléen ».
- 1 point : obtenir `True`.
- 1 point : contrôler le cas limite « reste nul » ou expliquer pourquoi il ne s’applique pas.
- Retrait possible : confusion avec l’erreur fréquente EF3 - Oublier de tester la valeur zéro dans une fonction numérique.
### Barème question 4
- 1 point : identifier correctement fonction courte et la donnée `def f(a): return 2*a + 1` avec `a = 5`.
- 1 point : appliquer la méthode « substituer l’argument et distinguer retour et affichage ».
- 1 point : obtenir `11` retourné.
- 1 point : contrôler le cas limite « aucun affichage sans `print` » ou expliquer pourquoi il ne s’applique pas.
- Retrait possible : confusion avec l’erreur fréquente EF4 - Donner une sortie sans trace intermédiaire.
## Exercices numérotés
