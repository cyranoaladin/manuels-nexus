...
Integration base: `10cb5f07772842d6630d2a2f78531f6900371023`.

- QCM teacher-key zones: 35
- Tracked-PDF STUDENT_TEACHER_ONLY_LEAKS: 0
- Tracked-PDF TEACHER_REQUIRED_KEYS_PRESENT: YES
- Current QCM source guards: PASS
- Eight tracked-PDF diagnostics: PASS
- Current-head PDF build attestation: NO
- Release evidence: NO

## Counts by manual

- `1SPE`: student 0; teacher 10/10
- `TCOMPL`: student 0; teacher 9/9
- `TEXPERTES`: student 0; teacher 5/5
- `TSPE`: student 0; teacher 11/11
