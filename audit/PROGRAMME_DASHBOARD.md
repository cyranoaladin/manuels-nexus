...
| `MANUAL_OBJECTS_INDEXED` | 3494 | `audit/OFFICIAL_TO_MANUAL_COVERAGE.json` :: summary / objects_indexed |
| `NEXUS_ALGORITHMIC_QUALITY_PARTS_WITHOUT_WORK` | 15 | `audit/OFFICIAL_TO_MANUAL_COVERAGE.json` :: summary / NEXUS_ALGORITHMIC_QUALITY_PARTS_WITHOUT_WORK |
...
| `INVALIDATED_APPROVALS_AWAITING_HUMAN_REVIEW` | 29 | `audit/CONTENT_APPROVAL_RECEIPTS.json` :: summary / INVALIDATED_APPROVALS_AWAITING_HUMAN_REVIEW |
