...
| `MANUAL_OBJECTS_INDEXED` | 3515 | `audit/OFFICIAL_TO_MANUAL_COVERAGE.json` :: summary / objects_indexed |
| `NEXUS_ALGORITHMIC_QUALITY_PARTS_WITHOUT_WORK` | 0 | `audit/OFFICIAL_TO_MANUAL_COVERAGE.json` :: summary / NEXUS_ALGORITHMIC_QUALITY_PARTS_WITHOUT_WORK |
| `NEXUS_ALGORITHMIC_QUALITY_PARTS_WITHOUT_ACTIONABLE_WORK` | 0 | `audit/OFFICIAL_TO_MANUAL_COVERAGE.json` :: summary / NEXUS_ALGORITHMIC_QUALITY_PARTS_WITHOUT_ACTIONABLE_WORK |
...
| `AUTOMATISMS_1SPE_ADEQUATELY_REINVESTED` | 17 | `audit/1SPE_AUTOMATISMS_AUDIT.json` :: summary / AUTOMATISMS_1SPE_ADEQUATELY_REINVESTED |
...
| `REMOVED_2019_CONTENT_REQUIRING_EDITORIAL_REVIEW` | 0 | `audit/1SPE_REFORM_TRANSITION_AUDIT.json` :: summary / REMOVED_2019_CONTENT_REQUIRING_EDITORIAL_REVIEW |
| `REMOVED_TRULY_REMOVED` | 2 | `audit/1SPE_REFORM_TRANSITION_AUDIT.json` :: summary / REMOVED_TRULY_REMOVED |
| `REMOVED_STILL_REQUIRED_UNDER_2026_WORDING` | 2 | `audit/1SPE_REFORM_TRANSITION_AUDIT.json` :: summary / REMOVED_STILL_REQUIRED_UNDER_2026_WORDING |
| `REMOVED_OPTIONAL_BUT_USEFUL` | 1 | `audit/1SPE_REFORM_TRANSITION_AUDIT.json` :: summary / REMOVED_OPTIONAL_BUT_USEFUL |
...
| `AUTOMATISMS_BELOW_NEXUS_STANDARD` | 0 | `audit/1SPE_AUTOMATISMS_AUDIT.json` :: summary / AUTOMATISMS_BELOW_NEXUS_STANDARD |
...
| `UNCLASSIFIED_OUT_OF_PROGRAMME_OBJECTS` | 0 | `audit/OBJECTS_TO_OFFICIAL_REVERSE_MAP.json` :: summary / UNCLASSIFIED_OUT_OF_PROGRAMME_OBJECTS |
...
| `FALSE_MISSING_TOOLING` | 7 | `audit/PROGRAMME_COUNTER_EXPERTISE_REPORT.json` :: summary / FALSE_MISSING_TOOLING |
| `MISSING_FROM_ASSEMBLY` | 4 | `audit/PROGRAMME_COUNTER_EXPERTISE_REPORT.json` :: summary / MISSING_FROM_ASSEMBLY |
| `TRUE_CONTENT_GAP` | 2 | `audit/PROGRAMME_COUNTER_EXPERTISE_REPORT.json` :: summary / TRUE_CONTENT_GAP |
| `FALSE_PARTIAL_TOOLING` | 42 | `audit/PROGRAMME_COUNTER_EXPERTISE_REPORT.json` :: summary / FALSE_PARTIAL_TOOLING |
| `TRUE_PARTIAL_PEDAGOGICAL` | 3 | `audit/PROGRAMME_COUNTER_EXPERTISE_REPORT.json` :: summary / TRUE_PARTIAL_PEDAGOGICAL |
| `CONTENT_CREATED_FOR_TRUE_MISSING` | 2 | `audit/PROGRAMME_COUNTER_EXPERTISE_REPORT.json` :: summary / CONTENT_CREATED_FOR_TRUE_MISSING |
| `CONTENT_CREATED_FOR_TRUE_PARTIAL_PEDAGOGICAL` | 6 | `audit/PROGRAMME_COUNTER_EXPERTISE_REPORT.json` :: summary / CONTENT_CREATED_FOR_TRUE_PARTIAL_PEDAGOGICAL |
| `CONTENT_CREATED_AFTER_UNDECIDABLE_REVIEW` | 1 | `audit/PROGRAMME_COUNTER_EXPERTISE_REPORT.json` :: summary / CONTENT_CREATED_AFTER_UNDECIDABLE_REVIEW |
| `CONTENT_CREATED_FOR_NEXUS_QUALITY_ENRICHMENT` | 2 | `audit/PROGRAMME_COUNTER_EXPERTISE_REPORT.json` :: summary / CONTENT_CREATED_FOR_NEXUS_QUALITY_ENRICHMENT |
| `STALE_APPROVAL_AFTER_SEMANTIC_EDIT` | 0 | `audit/CONTENT_APPROVAL_RECEIPTS.json` :: summary / STALE_APPROVAL_AFTER_SEMANTIC_EDIT |
| `SEMANTIC_CHANGE_PRESERVES_OLD_HUMAN_APPROVAL` | PASS | `audit/CONTENT_APPROVAL_RECEIPTS.json` :: summary / SEMANTIC_CHANGE_PRESERVES_OLD_HUMAN_APPROVAL |
| `SEMANTIC_CHANGE_INVALIDATES_REVIEW_RECEIPT` | PASS | `audit/CONTENT_APPROVAL_RECEIPTS.json` :: summary / SEMANTIC_CHANGE_INVALIDATES_REVIEW_RECEIPT |
| `INVALIDATED_APPROVALS_AWAITING_HUMAN_REVIEW` | 30 | `audit/CONTENT_APPROVAL_RECEIPTS.json` :: summary / INVALIDATED_APPROVALS_AWAITING_HUMAN_REVIEW |
