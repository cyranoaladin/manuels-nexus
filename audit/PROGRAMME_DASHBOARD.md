...
| `OFFICIAL_REQUIRED_COMPLETE` | 575 | `audit/OFFICIAL_TO_MANUAL_COVERAGE.json` :: summary / OFFICIAL_REQUIRED_COMPLETE |
| `OFFICIAL_REQUIRED_PARTIAL` | 38 | `audit/OFFICIAL_TO_MANUAL_COVERAGE.json` :: summary / OFFICIAL_REQUIRED_PARTIAL |
| `OFFICIAL_REQUIRED_MISSING` | 9 | `audit/OFFICIAL_TO_MANUAL_COVERAGE.json` :: summary / OFFICIAL_REQUIRED_MISSING |
...
| `UNCLASSIFIED_OUT_OF_PROGRAMME_OBJECTS` | 6 | `audit/OBJECTS_TO_OFFICIAL_REVERSE_MAP.json` :: summary / UNCLASSIFIED_OUT_OF_PROGRAMME_OBJECTS |
