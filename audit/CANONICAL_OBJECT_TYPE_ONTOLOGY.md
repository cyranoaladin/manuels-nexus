...
| `experimentation` | investigation empirique ou simulée d’un phénomène mathématique | `cours` | `sections_cours` | complet, élève, parcours 1, professeur | incluse transitivement par le cours canonique et acceptée par l’assembleur Math ; statuts inchangés | aucun | conception, assembleur, corpus |
