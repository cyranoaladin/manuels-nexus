...
- Candidats issus des référentiels internes : **312**
- `STRUCTURALLY_MAPPED` dans ce périmètre interne : **312**
...
- `OUT_OF_SCOPE_WITH_PROOF` : **3**
- `WRONG_YEAR` : **2**
- `UNSUPPORTED_CLAIM` : **0**

## Couverture par manuel

- `1SPE` : 53 candidats internes ; structurellement mappés=53 ; FULL=0.
...
- `TNSI` : 59 candidats internes ; structurellement mappés=59 ; FULL=0.
