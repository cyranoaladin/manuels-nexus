...
- `Mathematiques/manuel-maths/gabarits/nexus-code.tex` — ACTIVE_PROJECT_LOCAL_RUNTIME — La résolution relative au répertoire projet sélectionne cet asset local pendant les builds de la famille concernée. Preuve : `gabarits/common/nexus-manuel.cls:595`. Consommateurs : 1SPE:eleve, 1SPE:professeur, TCOMPL:eleve, TCOMPL:professeur, TEXPERTES:eleve, TEXPERTES:professeur, TSPE:eleve, TSPE:professeur.
- `Mathematiques/manuel-maths/gabarits/nexus-figures-nsi.tex` — ACTIVE_PROJECT_LOCAL_RUNTIME — La résolution relative au répertoire projet sélectionne cet asset local pendant les builds de la famille concernée. Preuve : `gabarits/common/nexus-manuel.cls:598`. Consommateurs : 1SPE:eleve, 1SPE:professeur, TCOMPL:eleve, TCOMPL:professeur, TEXPERTES:eleve, TEXPERTES:professeur, TSPE:eleve, TSPE:professeur.
- `Mathematiques/manuel-maths/gabarits/nexus-figures.tex` — ACTIVE_PROJECT_LOCAL_RUNTIME — La résolution relative au répertoire projet sélectionne cet asset local pendant les builds de la famille concernée. Preuve : `gabarits/common/nexus-manuel.cls:580`. Consommateurs : 1SPE:eleve, 1SPE:professeur, TCOMPL:eleve, TCOMPL:professeur, TEXPERTES:eleve, TEXPERTES:professeur, TSPE:eleve, TSPE:professeur.
- `Mathematiques/manuel-maths/gabarits/nexus-icons.tex` — ACTIVE_PROJECT_LOCAL_RUNTIME — La résolution relative au répertoire projet sélectionne cet asset local pendant les builds de la famille concernée. Preuve : `gabarits/common/nexus-manuel.cls:576`. Consommateurs : 1SPE:eleve, 1SPE:professeur, TCOMPL:eleve, TCOMPL:professeur, TEXPERTES:eleve, TEXPERTES:professeur, TSPE:eleve, TSPE:professeur.
...
- `Mathematiques/manuel-maths/gabarits/nexus-signatures.tex` — ACTIVE_PROJECT_LOCAL_RUNTIME — La résolution relative au répertoire projet sélectionne cet asset local pendant les builds de la famille concernée. Preuve : `gabarits/common/nexus-manuel.cls:591`. Consommateurs : 1SPE:eleve, 1SPE:professeur, TCOMPL:eleve, TCOMPL:professeur, TEXPERTES:eleve, TEXPERTES:professeur, TSPE:eleve, TSPE:professeur.
...
- `NSI/gabarits/nexus-code.tex` — ACTIVE_PROJECT_LOCAL_RUNTIME — La résolution relative au répertoire projet sélectionne cet asset local pendant les builds de la famille concernée. Preuve : `gabarits/common/nexus-manuel.cls:595`. Consommateurs : 1NSI:eleve, 1NSI:professeur, TNSI:eleve, TNSI:professeur.
- `NSI/gabarits/nexus-figures-nsi.tex` — ACTIVE_PROJECT_LOCAL_RUNTIME — La résolution relative au répertoire projet sélectionne cet asset local pendant les builds de la famille concernée. Preuve : `gabarits/common/nexus-manuel.cls:598`. Consommateurs : 1NSI:eleve, 1NSI:professeur, TNSI:eleve, TNSI:professeur.
- `NSI/gabarits/nexus-figures.tex` — ACTIVE_PROJECT_LOCAL_RUNTIME — La résolution relative au répertoire projet sélectionne cet asset local pendant les builds de la famille concernée. Preuve : `gabarits/common/nexus-manuel.cls:580`. Consommateurs : 1NSI:eleve, 1NSI:professeur, TNSI:eleve, TNSI:professeur.
- `NSI/gabarits/nexus-icons.tex` — ACTIVE_PROJECT_LOCAL_RUNTIME — La résolution relative au répertoire projet sélectionne cet asset local pendant les builds de la famille concernée. Preuve : `gabarits/common/nexus-manuel.cls:576`. Consommateurs : 1NSI:eleve, 1NSI:professeur, TNSI:eleve, TNSI:professeur.
...
- `NSI/gabarits/nexus-signatures.tex` — ACTIVE_PROJECT_LOCAL_RUNTIME — La résolution relative au répertoire projet sélectionne cet asset local pendant les builds de la famille concernée. Preuve : `gabarits/common/nexus-manuel.cls:591`. Consommateurs : 1NSI:eleve, 1NSI:professeur, TNSI:eleve, TNSI:professeur.
