...
- Motifs bruts (`RAW_REASON_COUNT`) : `451`
...
| `ROOT-DELIVERABLE-NOT-DECLARED` | `PRODUCT_P1` | Assemblages de variantes non déclarés | 2 |
...
| `ROOT-PRODUCER-STALE` | `CERTIFICATION_BLOCKER` | Producteurs de preuve stale ou rouges | 10 |
