...
- Motifs bruts (`RAW_REASON_COUNT`) : `557`
- Bloqueurs racines (`ROOT_BLOCKER_COUNT`) : `24`
...
| `ROOT-DELIVERABLE-NOT-BUILT` | `PRODUCT_P1` | Variantes déclarées jamais construites | 8 |
...
| `ROOT-DIMENSION-NOT-COVERED` | `CERTIFICATION_BLOCKER` | Dimensions de certification sans preuve | 4 |
...
| `ROOT-GATE-CHECK-ERROR` | `CERTIFICATION_BLOCKER` | Erreur fatale de contrôle du gate | 2 |
| `ROOT-HUMAN-REVIEW-QUEUE` | `CERTIFICATION_BLOCKER` | File de revue humaine ouverte | 53 |
| `ROOT-INVENTORY-UNAVAILABLE` | `CERTIFICATION_BLOCKER` | Inventaire indisponible | 1 |
| `ROOT-MISSING-CHAPTERS` | `PRODUCT_P0` | Chapitres attendus absents de l'inventaire | 1 |
| `ROOT-NON-APPROVED-STATUSES` | `GOVERNANCE_BLOCKER` | Objets et contrats non approuvés | 10 |
...
| `ROOT-PRODUCER-STALE` | `CERTIFICATION_BLOCKER` | Producteurs de preuve stale ou rouges | 7 |
...
| `ROOT-QUALIFICATION-STALE` | `CERTIFICATION_BLOCKER` | Qualifications dérivées invalidées par une mutation de source | 178 |
