...
- Motifs bruts (`RAW_REASON_COUNT`) : `480`
- Bloqueurs racines (`ROOT_BLOCKER_COUNT`) : `21`
- Motifs non classés (`UNMAPPED_RAW_REASONS`) : `2`
...
| `ROOT-COLLECTION-POLICY` | `RELEASE_POLICY_BLOCKER` | Règle de collection non satisfaite | 1 |
...
| `ROOT-PRODUCER-STALE` | `CERTIFICATION_BLOCKER` | Producteurs de preuve stale ou rouges | 12 |
