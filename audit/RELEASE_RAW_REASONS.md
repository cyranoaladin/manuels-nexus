...
- Motifs bruts (`RAW_REASON_COUNT`) : `478`
- Bloqueurs racines (`ROOT_BLOCKER_COUNT`) : `20`
- Motifs non classés (`UNMAPPED_RAW_REASONS`) : `3`
...
| `ROOT-DELIVERABLE-NOT-BUILT` | `PRODUCT_P1` | Variantes déclarées jamais construites | 24 |
| `ROOT-DELIVERABLE-NOT-COMPILED` | `PRODUCT_P1` | Livrables déclarés non compilés | 16 |
| `ROOT-DELIVERABLE-NOT-DECLARED` | `PRODUCT_P1` | Assemblages de variantes non déclarés | 4 |
...
| `ROOT-PRODUCER-STALE` | `CERTIFICATION_BLOCKER` | Producteurs de preuve stale ou rouges | 11 |
