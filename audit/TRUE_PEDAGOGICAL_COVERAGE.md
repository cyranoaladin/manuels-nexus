...
- cellules avec déclaration exacte (alignement sémantique à établir) : `1947`
- **unités d'écriture requises** : `307`
...
| `TCOMPL` | 0 | 1 | 0 | 0 | 44 | 0 | 0 | **45** |
| `TSPE` | 0 | 14 | 0 | 0 | 25 | 0 | 0 | **39** |
| `TEXPERTES` | 0 | 0 | 0 | 0 | 25 | 0 | 0 | **25** |
